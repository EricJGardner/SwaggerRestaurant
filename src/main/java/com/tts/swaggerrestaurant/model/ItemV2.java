...
public class ItemV2 {
//@ApiModelProperty allows for more descriptive code. Code should be as self-descriptive as possible
    @ApiModelProperty(notes = "The name of the menu item")
    private String name;
    @ApiModelProperty(notes = "The description of the menu item")
    private String description;
    @ApiModelProperty(notes = "The category of the menu item (appetizer, dessert, entree, etc)")
    ...
    @ApiModelProperty(notes = "If item is vegetarian")
    ...
    public ItemV2(String name, String description, String category,
                  List<String> ingredients, double price, Date createdDate, Date updatedDate, Boolean isVegetarian) {
        this.name = name;
        this.description = description;
        this.category = category;
        this.ingredients = ingredients;
